...
- [ ] Use lol_html to rewrite naked tags in definition terms to IDed anchors
- [ ] Use lol_html to rewrite unlinked tag refs to links
  + [ ] By querying the db for locations of logical units.
