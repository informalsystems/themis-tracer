...
- [ ] Change ~ARGS~ to *not* be standalone and go ~--to html~ file:./src/pandoc.rs::37
- [ ] rework ~pandoc_from_bytes~ to html_from_bytes file:./src/pandoc.rs::41
...
- [ ] Rework ~parse_string~ file:./src/pandoc.rs::53
- [ ] Rework ~parse_file~ file:./src/pandoc.rs::108
- [ ] Replace ~{inline,block}_to_string~ with ~html2md~ file:./src/pandoc.rs::130:238
- [ ] Rework ~parse_ast~ and ~logical_units_of_deflist~ to use ~scraper~ file:src/artifact.rs::74
