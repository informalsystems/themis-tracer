...
** TODO Prep for demo
*** TODO Report on duplicate logical units
*** TODO Ensure any logical units have a parent
*** TODO Implement helper bash functions
- [ ] Put existing aliases in a sh file in the repo that we can source.
- [ ] Make function for jumping to source file of unit
  #+begin_src sh
...
- editor integration?
***** What's next
*** TODO Install rusty status line thing
