...
- [ ] Add tests to ensure anchored (and other styled tags) are parsed correctly
- [ ] Write regex to identify unanchored tags
- [ ] Write function to rewrite tags into anchors
- [ ] Write regex to identify tag references
- [ ] Write function to collect all unlinked tag references, and generate their
  links, based on the database.
